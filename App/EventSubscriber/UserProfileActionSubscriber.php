 ...
 * protected constant.
 */
class UserProfileActionSubscriber implements EventSubscriberInterface
{
    ...
    protected const REDIRECT_PATH = '/profile/account/index';
     ...
     * @throws Exception
     */
    public function flashLoginEvent(UserProfileActionEvent $event)
    {
        $this->flashingEvent($event, function ($cbEvent, $routeArray) {
                $cbEvent->getObject()->redirect($cbEvent->getObject()->onSelf());
            });
    }
}