 ...
 * protected constant.
 */
class ProjectActionSubscriber implements EventSubscriberInterface
{
     ...
     * @return array
     */
    #[ArrayShape([ProjectActionEvent::NAME => 'array'])]
 public static function getSubscribedEvents(): array
 {
     return [
         ProjectActionEvent::NAME => [
             ['flashProjectEvent', self::FLASH_MESSAGE_PRIORITY],
         ],
     ];
 }
     ...
     *
     * @param ProjectActionEvent $event
     * @return void
     * @throws Exception
     */
    public function flashProjectEvent(ProjectActionEvent $event)
    {
