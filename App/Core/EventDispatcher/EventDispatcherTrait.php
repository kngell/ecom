...
trait EventDispatcherTrait
{
    ...
    {
        $feedback = YamlFile::get('events')['services']['subscribers'][strtolower($event->getObject()->thisRouteController() . '.subscriber')]['register_route_feedback'];
     ...
     * @return void
     */
    public function flashingEvent(Object $event, ?Closure $cb = null)
    {
