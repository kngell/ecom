...
trait MakeCommandTrait
{
    ...
    private function resolveClassNameSuffix(string $classNameSuffix, string $classNamePrefix, mixed $options = null)
    {
        ...
        list($newContentStream, $qualifiedClass, $qualifiedNamespace) = $this->resolveStubContentPlaceholders($file, $classNameSuffix, $classNamePrefix);
                ...
                foreach ($patterns as $pattern) {
                    if (str_contains($contentStream, $pattern)) {
                        if (isset($pattern) && $pattern != '') {
                            ...
                            $newContentStream = str_replace($patterns, [$qualifiedClass, $_namespace . ';', $property, $tableName, $modelName, $modelVar], $contentStream);
